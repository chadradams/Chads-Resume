...
Principal Frontend Engineer specializing in AI user interfaces with 19+ years bridging AI architecture, frontend engineering, and user experience to make complex systems usable and scalable. Proven expertise architecting AI-driven platforms handling 50M+ API calls monthly, leading Responsible AI initiatives, and delivering cross-platform experiences (React, Angular, TypeScript, SwiftUI).

---

## CORE COMPETENCIES

**AI & Architecture:** Generative AI, Multi-Agent Systems (AutoGen, Semantic Kernel, Microsoft Agent Framework), Frontend Architecture, Software Architecture, Responsible AI & Governance
